    ...
    public class People
    {
        ...
        public People()
        {
            peopleList = new List<Person>() {
                ...
                new Person { Name = "Pepe" , Age = 20, dateAdmissionCompany = DateTime.Now.AddMonths(-3), Single = true},
                new Person { Name = "Pablo" , Age = 20, dateAdmissionCompany = DateTime.Now.AddMonths(-5), Single = false},
            };
        }
    }
}
